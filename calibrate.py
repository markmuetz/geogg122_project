...
def calibrate_model(data, start_date, end_date):
	...
	p_est = optimize.fmin_powell(objective_f, p_guess, args=(model_data, discharge_for_year),
	...
	#p_est = optimize.fmin_bfgs(objective_f, p_guess, fprime=None, args=(model_data, discharge_for_year),
